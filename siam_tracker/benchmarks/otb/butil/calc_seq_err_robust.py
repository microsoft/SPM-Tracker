import math
from .calc_rect_center import rect_affine_IVT, rect_4corners, rect_affine_L1, rect_affine_LK, rect_similarity
from . import ssd
...
def calc_seq_err_robust(results, rect_anno):
    ...
    logging.info('seq_length = {}, len(rect_anno) = {}'.format(seq_length, len(rect_anno)))
