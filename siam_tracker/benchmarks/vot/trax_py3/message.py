...
PARSE_STATE_TYPE, PARSE_STATE_SPACE_EXPECT, PARSE_STATE_SPACE, PARSE_STATE_UNQUOTED_KEY, PARSE_STATE_UNQUOTED_VALUE, PARSE_STATE_UNQUOTED_ESCAPE_KEY, PARSE_STATE_UNQUOTED_ESCAPE_VALUE, PARSE_STATE_QUOTED_KEY, PARSE_STATE_QUOTED_VALUE, PARSE_STATE_QUOTED_ESCAPE_KEY, PARSE_STATE_QUOTED_ESCAPE_VALUE = range(0, 11)
